...
# Which relations to summarize for verbs
...
# You can swap this to your "unified soup" if you prefer.
...
# --- reconstruct sentence strings for examples
# sentence key
...
# --- self-join to get head lemma/upos for each dependent
